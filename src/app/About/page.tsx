        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0">
          ...
          <div className="md:max-w-xl">
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              My journey into the world of web development began a few years ago, and since then, I’ve been
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              covering topics like HTML, CSS, JavaScript, React, and more. Whether you're a beginner or an
