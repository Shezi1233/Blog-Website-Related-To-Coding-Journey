...
// Example blog card data, replace this with dynamic data from an API or database
const blogData = [
  {
    id: 1,
...
const BlogCard: React.FC<BlogCardProps> = ({ title, description, author, date, image }) => {
  return (
    <motion.div 
